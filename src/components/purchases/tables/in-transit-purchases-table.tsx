...
export function InTransitPurchasesTable({
  orgSlug,
  purchases,
}: InTransitPurchasesTableProps) {
  ...
  const columns = useMemo(
    () => createInTransitPurchasesColumns(orgSlug, supplierOptions),
      ...
      <div className="rounded-md border">
        <Empty>
          <EmptyHeader>
            ...
            <EmptyTitle>No hay compras en tránsito</EmptyTitle>
            <EmptyDescription>
              No hay compras con estado "En tránsito" en este momento.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
      </div>
