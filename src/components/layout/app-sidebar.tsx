  ...
  const navCategories: NavCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiredPermission: ["collections.read", "collections.read.all"],
        },
        {
          title: "Finanzas",
          url: `/org/${orgSlug}/finanzas`,
          icon: <ChartLineUpIcon weight="duotone" />,
          requiredPermission: ["finances.read", "finances.read.all"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiredPermission: ["creditnotes.read", "creditnotes.read.all"],
        },
        {
          title: "Notas de Débito",
          url: `/org/${orgSlug}/notas-de-debito`,
          icon: <ReceiptIcon weight="duotone" />,
          requiredPermission: "debitnotes.read",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: <ReceiptIcon weight="duotone" />,
          requiredPermission: ["pos.read", "pos.read.all"],
          module: "pos",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiredPermission: ["suppliers.read", "suppliers.read.all"],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: <ListBulletsIcon weight="duotone" />,
          requiredPermission: ["pricelists.read", "pricelists.read.all"],
        },
        {
      ...
      items: [
        {
          ...
          requiredPermission: ["accounting.read", "accounting.manage"],
          module: "accounting",
        },
        {
