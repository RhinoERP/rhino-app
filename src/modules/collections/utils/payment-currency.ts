 ...
 * deuda. Para deudas USD la tasa es la de la factura (fijada al emitir el
 * comprobante) y el `amount` guardado queda en la moneda de la deuda (descuenta
 * el saldo tal cual) mientras que `amount_ars` es su valuación contable a esa
 * tasa.
 */
