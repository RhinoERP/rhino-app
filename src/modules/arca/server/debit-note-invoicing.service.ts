...
export async function emitDebitNoteArcaInvoice(
  orgSlug: string,
  debitNoteId: string
): Promise<EmitDebitNoteArcaResult> {
  ...
  if (data.status === "CANCELLED") {
    throw new ArcaValidationError("La nota de débito está cancelada.");
  }
