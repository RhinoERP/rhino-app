...
export type ArcaBulkSaleInvoiceItemStatus =
  | "authorized"
  | "already_authorized"
  | "error";

export type ArcaBulkSaleInvoiceItemResult = {
  saleId: string;
  saleNumber: string | null;
  customerName: string | null;
  status: ArcaBulkSaleInvoiceItemStatus;
  invoiceNumber: string | null;
  cae: string | null;
  message: string;
};

export type ArcaBulkSaleInvoiceResult = {
  processedCount: number;
  authorizedCount: number;
  alreadyAuthorizedCount: number;
  errorCount: number;
  results: ArcaBulkSaleInvoiceItemResult[];
};
